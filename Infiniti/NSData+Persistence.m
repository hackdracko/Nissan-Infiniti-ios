...
@implementation NSData (Persistence)
...
-(BOOL)saveDataWithFileName:(NSString *)fileName
{
    ...
    BOOL result = [self writeToFile:completeFilePath atomically:YES];
...
+(NSData *)dataFromFileName:(NSString *)fileName
{
    ...
    NSData *result = [NSData dataWithContentsOfFile:completeFilePath];
