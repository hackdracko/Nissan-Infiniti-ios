...
@interface SEECMenuViewController : UIViewController

@property (retain, nonatomic) IBOutlet UILabel *MenuUserLabel;

@property (retain, nonatomic) IBOutlet UILabel *MenuDealerSelected;
