...
- (void)buildThumbsViewPhotos
{
	...
	for (i = 0; i < count; i++) {
		...
		[thumbView setTag:i];
        [thumbView.button setTag:kBUTTON_OFFSET + i];
...
- (void)handleThumbClick:(UIButton *)sender
{
    ...
    // To associate action of clicking the thumbnail :
    
    /*
    if ([self.photoActionDelegate respondsToSelector:@selector(photoGallery:clickedPhotoAtIndex:)])
    {
        [self.photoActionDelegate photoGallery:self clickedPhotoAtIndex:sender.tag - kBUTTON_OFFSET];
    }*/
}
