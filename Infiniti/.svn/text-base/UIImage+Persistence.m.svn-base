...
-(BOOL)saveImageWithFileName:(NSString *)fileName
{
    ...
    BOOL result = [imageData writeToFile:completeFilePath atomically:YES];
...
+(UIImage *)imageFromFileName:(NSString *)fileName
{
    ...
    UIImage *result = [UIImage imageWithContentsOfFile:completeFilePath];
    [completeFilePath release];
    return result;
}

+(NSString *)imagePathFromFileName:(NSString *)fileName
{
    NSFileManager *fileManager;
    NSString *documentsDirectory;
    NSArray *documentPaths;
    ...
    return [completeFilePath autorelease];
}
