...
@interface SEECSearchByPhaseViewController : UITableViewController

@property (retain) NSMutableArray *allEvaluation;
@property (retain) NSMutableArray *selectedBranches;
@property (assign) NSString *phase;
