...
#import "SEECReportViewController.h"
...
@interface SEECReportViewController ()



@end

@implementation SEECReportViewController
...
- (IBAction)showSearch:(UIButton *)sender {
    ...
    [self.popOverByType presentPopoverFromRect:sender.frame
                                             inView:self.view
                           permittedArrowDirections:UIPopoverArrowDirectionLeft
                                           animated:NO];
...
-(void)selectPhaseWithNotification:(NSNotification *)notification
{
    ...
    [self.popOverByType dismissPopoverAnimated:YES];
...
-(void)selectBranchWithNotification:(NSNotification *)notification
{
    ...
    self.zoneName.text = [branchDictionary valueForKey:@"subZone"];
...
-(void)selectBranchSearchedWithNotification:(NSNotification *)notification {
    ...
    self.stateName.text=   [self recoverInfo: @"seec_state" : @"LK_stateId == %@" : [branchDictionary valueForKey:@"FK_stateId"] : @"stateName" : @"dataroot" : @"seec_state" ];
    ...
    self.cityName.text =  [self recoverInfo: @"seec_city" : @"LK_cityId == %@" : [branchDictionary valueForKey:@"FK_cityId"] : @"cityName" : @"dataroot" : @"seec_city" ];
...
- (void)viewDidLoad
{
    ...
    //add pop for serch
    self.popOverByType = [[UIPopoverController alloc] initWithContentViewController:navControllerType];
