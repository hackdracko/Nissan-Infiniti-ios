...
{
    id anObject = [NSObject objectUsingArchiveWithFileName:fileName];
    
    return anObject;
}

-(BOOL)saveDictionaryWithFileName:(NSString *)fileName
{
    BOOL result = [self archiveObjectWithFileName:fileName];
