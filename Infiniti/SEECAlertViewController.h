...
@interface SEECAlertViewController : UIViewController


@property (retain, nonatomic) IBOutlet UILabel *branchLabel;

@property (retain, nonatomic) IBOutlet UILabel *operationLabel;

@property (retain, nonatomic) IBOutlet UILabel *directionLabel;

@property (retain, nonatomic) IBOutlet UILabel *phaseLabel;

@property (retain, nonatomic) IBOutlet UISwitch *slider;
