...
@interface SEECApplyEvaluationViewController : UIViewController
...
@property (retain, nonatomic) IBOutlet UIImageView *flagEvaluation;


@property (retain, nonatomic) IBOutlet UITextView *commentTitle;
