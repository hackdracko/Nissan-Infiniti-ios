...
@interface SEECLoginViewController : UIViewController
{
...
@property (retain) IBOutlet UITextField *userTextField;

@property (retain) IBOutlet UITextField *passwordTextField;
